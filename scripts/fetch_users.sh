...
# https://api-amis.upcebu.edu.ph/api/admins/users?page=1&items=5&access_permission=enlistment_manage
BASE_URL="https://api-amis.upcebu.edu.ph/api/admins/users"
HEADERS_FILE="headers.txt"
PAGE_SIZE=2500
QUERY_PARAMETERS="&items=${PAGE_SIZE}&access_permission=enlistment_manage&order_field=id"
